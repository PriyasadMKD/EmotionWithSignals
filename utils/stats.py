...
def load_data(file_name='../DREAMER.mat'):
    ...
    for i in range(23):
        ...
        for j in range(18):
            ...
            print(j,stim_eeg_video_i.shape[1]/128)
...
def segment_data_with_time(file_name='../DREAMER.mat',times=4):
    ...
    for i in range(23):
        ...
        for j in range(18):
            ...
            for k in range(0,eeg_length-128*times,128*times):
                save_file_eeg_stim = "../data/segmented/Subject"+str(i)+"/Subject_"+str(i)+'_Video_'+str(j)+'_'+str(v_video_i)+'_'+str(a_video_i)+'_'+str(d_video_i)+'_Segment'+str(k/128)+'_EEG'+str(times)+'44S_STIM.npy'
                save_file_eeg_base = "../data/segmented/Subject"+str(i)+"/Subject_"+str(i)+'_Video_'+str(j)+'_'+str(v_video_i)+'_'+str(a_video_i)+'_'+str(d_video_i)+'_Segment'+str(k/128)+'_EEG'+str(times)+'44S_BASE.npy'
    ...
    with open("eeg_data_segmented_"+str(times)+"444S_.txt", "w") as f:
        for s in data_list:
            f.write(str(s) +"\n")
            # print(save_file_eeg_stim)
            # print(save_file_eeg_base)
...
# segment_data_with_time(times=2)
segment_data_with_time(times=4)
